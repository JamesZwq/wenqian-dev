...
export default function ThemeToggle() {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.97 }}
      className="pointer-events-auto fixed bottom-4 right-4 z-[140] flex items-center gap-2 px-2 py-1 rounded-xl border border-[color-mix(in_oklab,var(--pixel-border)_90%,transparent)] bg-[color-mix(in_oklab,var(--pixel-bg)_88%,transparent)] shadow-lg"
    >
      {/* 文本标签 */}
      <motion.span
