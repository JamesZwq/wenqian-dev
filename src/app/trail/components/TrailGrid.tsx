...
import { targetSequence, type GridSize } from "../types";
...
// Format the cell display: numbers padded to 2 digits, letters as-is
...
export function TrailGrid({ cells, size, currentIndex, wrongClickIndex, onCellClick, disabled = false }: Props) {
  ...
  return (
    ...
    >
      {cells.map((value, i) => {
        const pos = seq.indexOf(value);
        const isCleared = pos >= 0 && pos < currentIndex;
